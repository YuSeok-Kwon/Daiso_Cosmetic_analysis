...
**SLI 상위 10% 연착륙 SKU (102개) 분석 결과:**

| 항목 | 수치 |
|------|------|
| SKU 수 | 102개 (전체 유효 691개 중 상위 10%) |
| 전체 매출 기여도 | **40.8%** |
| 평균 가격 | 4,063원 |
| 스킨케어 비중 | 69.6% (메이크업 29.4%) |
| 기초스킨케어 비중 | 42.2% (압도적 1위) |
| 상위 4개 소분류 합계 | 76.5% (기초+베이스+클렌징+팩) |

- **실행:** SLI 기반으로 증명된 '순한 데일리 스킨케어' 브랜드를 역으로 발굴하여 입점 제안
...
| 문서 경로 | 설명 |
| --------- | ---- |
| `07_docs/data/ERD.md` | ERD 및 테이블 상세 명세 |
| `07_docs/data/파생변수.md` | 파생변수 정의 및 활용 |
| `07_docs/data/데이터_파이프라인.md` | 데이터 수집·전처리 파이프라인 |
| `07_docs/data/연착륙 정리.pdf` | SLI(Soft Landing Index) 분석 방법론 및 결과 |
| `07_docs/daiso/다이소 EDA_v1.md` | 다이소 뷰티 EDA 분석 |
...
| 문서 경로 | 설명 |
| --------- | ---- |
| `07_docs/search_trend/네이버_검색트렌드_분석_전체브랜드.md` | 전체 브랜드 검색 트렌드 |
| `07_docs/search_trend/네이버_검색트렌드_분석_제품단위.md` | 제품 단위 검색 트렌드 |
| `07_docs/search_trend/네이버_검색량_분석_전체브랜드.md` | 전체 브랜드 검색량 분석 |
| `07_docs/search_trend/네이버_검색량_분석_제품별.md` | 제품별 검색량 분석 |
